#!/usr/bin/env python3
"""
Safety Analysis Controller - 종합 안전도 분석 및 계산
"""
...
class SafetyAnalysisController:
    ...
    def calculate_comprehensive_safety(self):
        """종합 안전도 계산"""
        ...
        try:
            # 모든 데이터 수집
            dong_data = self.get_all_safety_data()
            ...
            # 결과 분석 생성
            analysis_result = self._generate_analysis_report(safety_scores)
            
            logger.info(f"Safety analysis completed successfully in {execution_time:.2f}s")
            
            return {
                'success': True,
                'safety_scores': safety_scores,
                'analysis_report': analysis_result,
                'total_dong_count': len(safety_scores),
    ...
    def _generate_analysis_report(self, safety_scores):
        """분석 결과 보고서 생성"""
        ...
        return {
            ...
            'top_15_dong': top_15,
            'bottom_15_dong': bottom_15,
            'district_averages': district_avg,
            'cpted_averages': {
                'natural_surveillance': avg_natural,
                'access_control': avg_access,
                'territoriality': avg_territory,
                'maintenance': avg_maintenance,
                'activity_support': avg_activity
            }
        }
    ...
    def run_update(self):
        ...
        return self.calculate_comprehensive_safety()